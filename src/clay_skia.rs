...
use skia_safe::{
    Canvas, ClipOp, Color, Font, Image, Paint, Point, RRect, Rect
};
        ...
        match command.config {
            ...
            RenderCommandConfig::Rectangle(rect) => {
                ...
                if rect.corner_radii.top_left > 0. {
                    // For simplicity use the top_left radius for all corners.
                    let rrect = RRect::new_rect_xy(bounds, rect.corner_radii.top_left, rect.corner_radii.top_left);
            ...
            RenderCommandConfig::Border(border) => {
                ...
                let draw_corner_arc = |canvas: &Canvas,
                                       ...
                                       start_angle: f32,
                                       sweep_angle: f32| {
                    let arc_rect = Rect::from_xywh(center_x - radius, center_y - radius, radius * 2.0, radius * 2.0);
                ...
                if border.corner_radii.top_left > 0. {
                    ...
                    draw_corner_arc(canvas, center_x, center_y, border.corner_radii.top_left, 180.0, 90.0);
                }
                ...
                if border.corner_radii.top_right > 0. {
                    ...
                    draw_corner_arc(canvas, center_x, center_y, border.corner_radii.top_right, 270.0, 90.0);
                }
                ...
                if border.corner_radii.bottom_left > 0. {
                    ...
                    draw_corner_arc(canvas, center_x, center_y, border.corner_radii.bottom_left, 90.0, 90.0);
                }
                ...
                if border.corner_radii.bottom_right > 0. {
                    ...
                    draw_corner_arc(canvas, center_x, center_y, border.corner_radii.bottom_right, 0.0, 90.0);
                }
            }
            RenderCommandConfig::Custom(custom) => todo!("Custom element rendering is not implemented yet: {custom:#?}"),
